...
const data = [
  ...
  },
  {
    ...
    options: ["Second doctor", "Second Master", "Section Grandmaster", "Second Great"],
  },
  {
    question:
      "What is the name of the main character in the third season of the show?",
    options: ["Third Doctor", "Third Master", "Third Grandmaster", "Third Great"],
  },
];

const MainForm = ({ setSection, section }) => {
  ...
  return (
    <div className="min-h-screen flex justify-center items-center">
          ...
          return (
            <Form className="flex justify-between">
              <div className="w-[40%]">
                ...
                <Image src="/icon-01.png" width={500} height={500} />
              </div>
              <div
                className="options"
                role="group"
      ...
      <div>
        <button
          className="border-[1px] rounded-full p-3 mt-5 absolute bottom-[10%] left-[48.5%] z-10 bg-white"
        ...
        <button
          className="border-[1px] rounded-full p-3 mt-5 absolute top-[10%] left-[48.5%] z-10 bg-white"
